...
| `Gamma Brevis Rewarder` ~ Sherlock | Gamma is a protocol for active liquidity management. This contest focuses on using Brevis' ZK coprocessor to validate and incentivize user liquidity positions. | [Link]([https://audits.sherlock.xyz/contests/496/report) | [2nd](https://audits.sherlock.xyz/contests/496/leaderboard)
| `Chainlink Rewards` ~ Code4rena | A community engagement and rewards program designed to incentivize active participation in the Chainlink Network.| Private | [3rd](https://code4rena.com/audits/2025-06-chainlink-rewards)
| `Rova` ~ Sherlock | Rova is a high quality onchain launchpad focused on small ticket, global retail public token sales. | [Link](https://audits.sherlock.xyz/contests/498/report) | [3rd](https://audits.sherlock.xyz/contests/498/leaderboard)
| `Flex Perpetuals` ~ Code4rena | A decentralized Perpetuals Exchange offering gasless trading, up to 100x leverage, and no KYC. With industry-leading rewards and Trade-to-Earn program, it ensures accessibility, security, and profitability.| [Link](https://code4rena.com/reports/2024-12-flex-perpetuals) | [4th](https://code4rena.com/audits/2024-12-flex-perpetuals)
| `Brevis Pico ZKVM` | Pico is an open-source, modular, and efficient zkVM that enables developers to generate zero-knowledge proofs for Rust programs. This contest focuses on identifying and eliminating potential security vulnerabilities or bugs to ensure Pico’s robustness before it is adopted in production by other projects. | [Link](https://audits.sherlock.xyz/contests/873/report) | [4th](https://x.com/0xpetern/status/1989645590486290678)
